...
walking_dis = 0.4;  % The maximum walk distance for each agent per random walk.
...
% Store the total number of susceptible, infected, hospitalized, recovered.
...
total_recovered = zeros(day_max,1);  
