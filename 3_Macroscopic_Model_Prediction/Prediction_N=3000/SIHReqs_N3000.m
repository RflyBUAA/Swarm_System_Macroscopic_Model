...
%     r_infect = 0.253;
%     d_rw = 0.1265;
    r_infect = 0.08; % Here it means that r_inf is reduced by a factor of sqrt(10) and also the parameter k(1) is reduced by a factor of sqrt(10)
    d_rw = 0.04; % Here it means that d_rw is reduced by a factor of sqrt(10) and also the parameter k(2) is reduced by a factor of sqrt(10)
    tau_sym = 5;
    p_det = 0.7;
    tau_det = 7;
    tau_rec = 7;
